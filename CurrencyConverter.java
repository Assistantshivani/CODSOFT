...
public class CurrencyConverter {
    ...
    public static double currencyConversionQuotient(String baseCurrency, String targetCurrency) throws Exception {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            double rate = currencyConversionQuotient(baseCurrency, targetCurrency);
